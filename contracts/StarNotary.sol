...
contract StarNotary is ERC721 {
    ...
    string public tokenName = 'FlashToken';
    string public tokenSymbol = 'FLASH';
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOfToken1 || msg.sender == ownerOfToken2,'Caller address is not the owner of either token');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == owner, 'Caller address is not the owner of the token');
